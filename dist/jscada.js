...
var Mounter = /** @class */ (function () {
    function Mounter(id, type, selector) {
        ...
        this._ensureElement = function () {
            ...
            if (!_this._element) {
                throw Error("Invalid mount point id: " + _this.id + ", cannot find the target element");
            }
        };
...
var JScada$1 = /** @class */ (function () {
    ...
    JScada.prototype.start = function () {
        ...
        sources.forEach(function (source) {
            ...
            var observable = adaptor.connect().takeWhile(function () { return _this.readyState === RS.READY; });
