	...
	assign(
		...
		autoBind({
			_onAdd: d_1(function (index) {
				...
				++this.__nextIndex__;
				if (!this.__redo__) {
					defineProperty$3(this, "__redo__", d_1("c", [index]));
					return;
				}
...
var polyfill = SetPoly = function Set(/*iterable*/) {
	...
	if (isNativeImplemented && setPrototypeOf) self = setPrototypeOf(new NativeSet(), getPrototypeOf(this));
	else self = this;
	if (iterable$$1 != null) iterator(iterable$$1);
	defineProperty(self, '__setData__', d_1('c', []));
...
eventEmitter(Object.defineProperties(SetPoly.prototype, {
	...
	values: d_1(function () { return new iterator$1(this); }),
	toString: d_1(function () { return '[object Set]'; })
}));
defineProperty(SetPoly.prototype, es6Symbol.iterator, d_1(getValues));
defineProperty(SetPoly.prototype, es6Symbol.toStringTag, d_1('c', 'Set'));

'use strict';

var es6Set = isImplemented() ? Set : polyfill;
...
var isArray$5 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Subscription = /** @class */ (function () {
    ...
    Subscription.prototype.unsubscribe = function () {
        ...
        if (isArray$5.isArray(_subscriptions)) {
            index = -1;
...
var Subject_3 = Subject_1$1.Subject;
...
var assign$3 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
exports.assign = getAssign(root$1.root);
...
var WebSocketSubject = /** @class */ (function (_super) {
    ...
    function WebSocketSubject(urlConfigOrSource, destination) {
        ...
        if (urlConfigOrSource instanceof Observable_1.Observable) {
            ...
            _this.WebSocketCtor = root$1.root.WebSocket;
            _this._output = new Subject_1$1.Subject();
            if (typeof urlConfigOrSource === 'string') {
                _this.url = urlConfigOrSource;
            }
            else {
                // WARNING: config object could override important members here.
                assign$3.assign(_this, urlConfigOrSource);
            }
    ...
    WebSocketSubject.prototype._resetState = function () {
        ...
        this._output = new Subject_1$1.Subject();
    };
...
var AjaxObservable_1$1 = createCommonjsModule(function (module, exports) {
"use strict";
var __extends = (commonjsGlobal && commonjsGlobal.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
exports.ajax = AjaxObservable_1$1.AjaxObservable.create;
...
function isNumeric(val) {
    ...
    return !isArray$5.isArray(val) && (val - parseFloat(val) + 1) >= 0;
}
...
var TimerObservable_1 = createCommonjsModule(function (module, exports) {
"use strict";
var __extends = (commonjsGlobal && commonjsGlobal.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var WebSocketSubject_1$1 = createCommonjsModule(function (module, exports) {
"use strict";
var __extends = (commonjsGlobal && commonjsGlobal.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
exports.webSocket = WebSocketSubject_1$1.WebSocketSubject.create;
...
var map$5 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var share_2 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var iterator$3 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function subscribeToResult(outerSubscriber, result, outerValue, outerIndex) {
    ...
    else if (result && typeof result[iterator$3.iterator] === 'function') {
        var iterator = result[iterator$3.iterator]();
        do {
...
var mergeMap_2 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
Observable_1.Observable.prototype.mergeMap = mergeMap_2.mergeMap;
Observable_1.Observable.prototype.flatMap = mergeMap_2.mergeMap;
...
var takeUntil_2 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var takeUntil = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var takeWhile_2 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var takeWhile = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var switchMap_2 = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var switchMap = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });


Observable_1.Observable.prototype.switchMap = switchMap_2.switchMap;
...
var _do = createCommonjsModule(function (module, exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var MqttAdaptor = /** @class */ (function () {
    ...
    MqttAdaptor.prototype.connect = function (cb) {
        var _this = this;
        if (cb === void 0) { cb = noop$3; }
    ...
    MqttAdaptor._connectionCount = 0;
...
var _container = ['svg', 'a', 'g'];
var _shape = ['path', 'rect', 'circle', 'ellipse', 'line', 'polyline', 'polygon'];
var _text = ['altGlyph', 'textPath', 'text', 'tref', 'tspan'];
var CONTAINTER = new Set(_container);
var CONTAINTER_SELECTOR = _container.join(',');
var SHAPE = new Set(_shape);
var SHAPE_SELECTOR = _shape.join(',');
var TEXT = new Set(_text);
var TEXT_SELECTOR = _text.join(',');
...
var Actions = (_a = {},
    ...
    _a[T.stroke] = function (node, data) {
        function setStroke(n, strokeValue) {
        ...
        if (isContainer(node)) {
            node.querySelectorAll(SHAPE_SELECTOR + ',' + TEXT_SELECTOR)
                .forEach(function (n) { return setStroke(n, data); });
            return;
        }
        if (isText(node) || isSHAPE(node)) {
            setStroke(node, data);
    ...
    _a[T.visible] = function (node, data) {
        if (!!data) {
    ...
    _a[T.opacity] = function (node, opacity) {
        var _opacity = {};
        ...
        for (var key in _opacity) {
            var attr = key + '-opacity';
            var val = _opacity[key];
            if (val === 1) {
    ...
    _a[T.rotate] = function (node, opacity) {
        throw new Error('Not Implemented');
    },
    _a[T.scale] = function (node, opacity) {
        throw new Error('Not Implemented');
    },
    _a[T.offset] = function (node, opacity) {
        throw new Error('Not Implemented');
    },
    _a);
var _a;
